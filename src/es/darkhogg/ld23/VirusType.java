...
public enum VirusType {
	...
	ATTACKER( new Polygon( new float[] { (float) Math.cos( Math.PI * 2 / 3 ), (float) Math.sin( Math.PI * 2 / 3 ),
		(float) Math.cos( Math.PI * 4 / 3 ), (float) Math.sin( Math.PI * 4 / 3 ), (float) Math.cos( Math.PI * 6 / 3 ),
		(float) Math.sin( Math.PI * 6 / 3 ), } ).transform( Transform.createScaleTransform( 1.3f, 1.3f ) ) ),
	
	/** A defender virus with a square for shape */
	DEFENDER( new Polygon(
		new float[] { (float) Math.cos( Math.PI * 2 / 4 ), (float) Math.sin( Math.PI * 2 / 4 ),
			(float) Math.cos( Math.PI * 4 / 4 ), (float) Math.sin( Math.PI * 4 / 4 ),
			(float) Math.cos( Math.PI * 6 / 4 ), (float) Math.sin( Math.PI * 6 / 4 ),
