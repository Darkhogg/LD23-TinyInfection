...
public final class Main {
    ...
    private static void setupLibraryPath () throws SecurityException, NoSuchFieldException, IllegalAccessException {
        ...
        if (os == OperatingSystem.LINUX
            | os == OperatingSystem.MAC | os == OperatingSystem.SOLARIS | os == OperatingSystem.WINDOWS)
        {
            ...
            // <oldpath>:lib/natives-os:natives-os
            String newlibpath = oldlibpath + pathsep + "lib" + dirsep + dirname + pathsep + "binlib" + dirsep + dirname;
    ...
    public static final class WrapperGame implements Game {
        ...
        public void render (GameContainer cont, Graphics gr) throws SlickException {
            if (buffer == null) {
                buffer = new ImageBuffer(LudumDare23Game.WIDTH, LudumDare23Game.HEIGHT).getImage(Image.FILTER_NEAREST);
            }
